...
base_url="https://pages.github.ibm.com/watson-health-playbook/"
#base_url="https://pages.github.ibm.com/WatsonHealthArchitecture/PlaybookDemo/"
    ...
    for dirpath, dirs, files in os.walk("../../_content"):
        for filename in os.listdir(dirpath):
            if filename.endswith(".md"):
                url = (dirpath + "/" + filename).replace("../../_content/", base_url).replace(".md","/")
